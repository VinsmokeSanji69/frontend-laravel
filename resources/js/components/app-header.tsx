...
const mainNavItems: NavItem[] = [
    ...
    { title: 'Get Started', href: '/#generate-exam' },
];
                        ...
                        >
                            ...
                            <div className="flex h-full flex-1 flex-col space-y-4 p-4">
                                <div className="flex h-full flex-col justify-between text-lg">
                                    ...
                                    {auth?.user && <UserProfile user={auth.user} isMobile={true} />}
                                </div>
                            </div>
                        </SheetContent>
                    </Sheet>
                        ...
                        <NavigationMenu className="flex h-full items-stretch">
                            <NavigationMenuList className="flex h-full items-stretch space-x-2">
                                {mainNavItems.map((item, index) => (
                                    <NavigationMenuLink key={index} className="relative flex h-full items-center">
                                        <Link
                                            href={item.href}
                                            className={cn(
                                                navigationMenuTriggerStyle(),
